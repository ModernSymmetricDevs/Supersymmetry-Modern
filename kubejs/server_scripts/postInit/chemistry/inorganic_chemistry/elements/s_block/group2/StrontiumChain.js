ServerEvents.recipes(event => {
  ...
  event.recipes.susy.gravity_separator('qc5dhaamzmth4h') // remapped from original line 16
    .itemInputs('1x #forge:dusts/celestine')
    .itemOutputs('1x #forge:dusts/sifted_celestine')
    .chancedOutput('1x #forge:dusts/limestone', 2500, 0)
    .chancedOutput('1x #forge:dusts/dolomite', 2500, 0)
    .EUt(voltAmps[1])
    .duration(40)

  event.recipes.gtceu.mixer('9sd9ysumyef641') // remapped from original line 25
  ...
  event.recipes.susy.froth_flotation('e6r8gmkeqgv9oc') // remapped from original line 33
  ...
  event.recipes.susy.clarifier('mq6vg2n2eddool') // remapped from original line 43
  ...
  //event.recipes.gtceu.mixer('7ymcf9e9dpsfyl') // remapped from original line 66
  ...
  event.recipes.susy.clarifier('8ob7ahbuxpmwtq') // remapped from original line 74
  ...
  event.recipes.susy.batch_reactor('ofryfco4o0mwxh') // remapped from original line 82
  ...
  event.recipes.susy.roaster('0hkmjlkjxgznse') // remapped from original line 93
  ...
  event.recipes.susy.roaster('wt0frgiymklf2w') // remapped from original line 101
  ...
  event.recipes.susy.reaction_furnace('b4mn0q6jlqo8ht') // remapped from original line 109
