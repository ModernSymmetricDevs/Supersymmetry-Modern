ServerEvents.recipes(event => {
  ...
  event.recipes.susy.roaster('dim6pasyfvxyww') // remapped from original line 8
  ...
  event.recipes.susy.roaster('eamrrakli83uno') // remapped from original line 17
  ...
  event.recipes.susy.batch_reactor('59ibkjntsfg83z') // remapped from original line 27
  ...
  event.recipes.susy.batch_reactor('i8dhhilvqsolyg') // remapped from original line 35
  ...
  event.recipes.gtceu.electrolytic_cell('lzj6ivslfueczo') // remapped from original line 46
  ...
  event.recipes.gtceu.ELECTROLYZER('avqdzuzjejfk2j') // remapped from original line 58
    .notConsumable('1x #forge:rods/nickel')
    .notConsumable('1x #forge:rods/iron')
