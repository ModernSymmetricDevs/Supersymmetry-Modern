ServerEvents.recipes(event => {
  ...
  event.recipes.gtceu.chemical_bath('hxwstgtwupr6p2') // remapped from original line 14
  ...
  event.recipes.gtceu.large_chemical_reactor('7hkvb46itmbkrq') // remapped from original line 24
  ...
  event.recipes.gtceu.mixer('etgi6wd6hgsc4r') // remapped from original line 32
  ...
  event.recipes.gtceu.chemical_bath('wvkrs52qnhsiql') // remapped from original line 40
  ...
  event.recipes.gtceu.compressor('lu7ihceh33y7l5') // remapped from original line 53
