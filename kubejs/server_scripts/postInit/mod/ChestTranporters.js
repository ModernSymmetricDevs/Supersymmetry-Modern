ServerEvents.recipes(event => {
  ...
  event.recipes.gtceu.assembler('mtoxmbthtpj1bq') // remapped from original line 36
  ...
  event.recipes.gtceu.assembler('lmasexvaauq7yv') // remapped from original line 44
    .itemInputs(safeItemId('4x minecraft:stick'))
